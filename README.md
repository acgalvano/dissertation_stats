...
Code was written through a combination of the author's own knowledge, material from the Info 251 course on Applied Machine Learning at UC Berkeley, and vibe coding using Chat GPT 5.1-5.2 with the Plus subscription. References to documentation are provided for sections of code obtained from the latter.
